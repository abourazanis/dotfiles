...
sudo defaults write /Library/Preferences/com.apple.loginwindow LoginwindowText \
    "Found this computer? Please contact Anastasis Bourazanis at a.bourazanis@gmail.com ."
...
# Log firewall events for 30 days.
...
# Log authentication events for 30 days.
...
# Set displaysleep to 2 minutes on batter
