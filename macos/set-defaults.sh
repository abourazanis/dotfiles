...
sudo defaults write /Library/Preferences/com.apple.loginwindow LoginwindowText \
    "Found this computer? Please contact Anastasios Bourazanis at a.bourazanis@gmail.com ."
...
defaults write NSGlobalDomain AppleLanguages -array "en-GR" "el-GR"
defaults write NSGlobalDomain AppleLocale -string "en_GR"
...
tell application "Terminal"
	...
	do shell script "open './system/" & themeName & ".terminal'"
